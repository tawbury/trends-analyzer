...
| Discovery quality evaluation / calibration | `src/ingestion/discovery/`, `src/db/repositories/discovery_review_repository.py` | `docs/specification/source/source_module_spec.md`, `docs/architecture/observability_ops.md` |
