...
| Discovery quality evaluation / calibration / rules | `src/ingestion/discovery/`, `src/db/repositories/discovery_review_repository.py`, `config/discovery_rules.example.json` | `docs/specification/source/source_module_spec.md`, `docs/architecture/observability_ops.md` |
