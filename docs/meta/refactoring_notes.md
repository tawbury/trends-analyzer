...
- `docs/specification/data/news_credibility_spec.md`를 추가했다.
...
- `docs/architecture/observability_ops.md`를 추가했다.
- `docs/architecture/deployment_topology.md`를 추가했다.
- `docs/meta/docs_index.md`로 문서 권위 기준을 정리했다.
...
- `docs/specification/api/api_draft.md`와 `docs/specification/api/api_spec.md`에 auth mode, idempotency conflict, standard error response, async job response, pagination/filter/sort 기준을 보강했다.
- `docs/architecture/environment_config.md`를 추가해 local/laptop/OCI 설정 차이, scheduler flag, market-hours guard flag, n8n secret/auth, source tier config path, runtime mode를 문서화했다.
...
- `docs/meta/document_metadata_standard.md`를 추가했다.
...
- `docs/specification/api/api_draft.md`는 API 제품/개요 초안, `docs/specification/api/api_spec.md`는 구현 계약의 source of truth로 분리했다.
- `contracts/api.py`는 transport DTO 전용이며, 규모가 커지면 `api_requests.py`와 `api_responses.py`로 분리한다고 문서화했다.
- 핵심 권위 문서에 `docs/meta/document_metadata_standard.md` 형식의 metadata header를 추가했다.
...
- `docs/meta/implementation_traceability.md`를 추가했다.
...
- `docs/architecture/master_planning.md`
- `docs/architecture/architecture_specification.md`
- `docs/architecture/module_design.md`
- `docs/specification/api/api_draft.md`
- `docs/specification/data/data_contract_draft.md`
- `docs/architecture/runtime_scheduling_policy.md`
- `docs/meta/refactoring_notes.md`
- `docs/appendix/example_code_appendix.md`
- `docs/meta/open_decisions.md`
- `docs/architecture/observability_ops.md`
- `docs/architecture/deployment_topology.md`
- `docs/meta/docs_index.md`
- `docs/architecture/environment_config.md`
- `docs/meta/document_metadata_standard.md`
- `docs/meta/implementation_traceability.md`
- `docs/specification/*`

## 4. 아직 남은 구현 의사결정

상세 목록은 `docs/meta/open_decisions.md`에서 추적한다.
